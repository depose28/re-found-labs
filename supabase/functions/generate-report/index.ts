...
<body>
  <div class="container">
    ...
    <div style="text-align: center; padding-top: 40px; border-top: 2px solid #e5e5e5; color: #999; font-size: 13px;">
      <p>Generated by AgentReady.com</p>
      <p>AI Commerce Readiness Assessment Tool</p>
    </div>
  </div>
</body>
</html>
...
serve(async (req) => {
  ...
  try {
    ...
    const { data: emailData, error: emailError } = await resend.emails.send({
      from: "AgentReady <onboarding@resend.dev>",
      to: [email],
      subject: `AI Commerce Readiness Report: ${analysis.domain} - Score ${analysis.total_score}/100`,
      html: htmlReport,
    });
