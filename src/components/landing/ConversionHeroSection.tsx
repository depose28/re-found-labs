...
const ConversionHeroSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data, error: analysisError } = await supabase.functions.invoke("analyze", {
        body: { url: url.trim() },
      });
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-20 relative">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-8 animate-slide-up" style={{ animationDelay: "0.1s" }}>
              Get your free Agent Readiness Score in 60 seconds. See exactly what ChatGPT, Claude, and Perplexity see when they try to recommend your products.
            </p>
            ...
            <form onSubmit={handleSubmit} className="animate-slide-up" style={{ animationDelay: "0.15s" }}>
              <div className="flex flex-col sm:flex-row gap-3 mb-4">
                ...
                <Button
                  ...
                  size="lg"
                  disabled={isLoading}
                  className="h-14 px-8 bg-foreground text-background hover:bg-foreground/90 font-medium text-base whitespace-nowrap"
                >
                  {isLoading ? (
                    <>
            ...
            {/* Trust badges */}
            <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground animate-slide-up" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="relative animate-fade-in" style={{ animationDelay: "0.3s" }}>
            ...
            <div className="bg-card border border-border shadow-2xl rounded-lg overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                ...
                {[
                  { icon: Search, label: "Discovery", score: 32, max: 40, color: "bg-success" },
                  { icon: Zap, label: "Performance", score: 11, max: 15, color: "bg-warning" },
                  { icon: CreditCard, label: "Transaction", score: 14, max: 20, color: "bg-warning" },
                  { icon: Shield, label: "Trust", score: 16, max: 25, color: "bg-warning" },
                ].map((cat, i) => (
              ...
              <div className="border-t border-border p-6">
                ...
                <div className="space-y-2">
                  {[
                    "Missing MerchantReturnPolicy schema",
        ...
        <div className="mt-16 pt-8 border-t border-border animate-fade-in" style={{ animationDelay: "0.4s" }}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: "10", label: "AI bots checked" },
              { value: "4", label: "Categories analyzed" },
              { value: "15+", label: "Checks per scan" },
              { value: "73%", label: "Of stores need work" },
            ].map((stat, i) => (
